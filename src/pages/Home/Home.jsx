    ...
    return (
        <div>
            ...
            <div className="flex flex-col roboto items-center justify-center min-h-screen ">
                ...
                <p className="text-2xl font-bold  mt-8 text-center text-white " > Hi, I am Sumon... </p>

                <p className="text-2xl font-bold mt-2 mb-2 text-center p-4 text-white" > A Junior Front End  Developer </p>
