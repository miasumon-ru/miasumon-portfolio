...
const Navbar = () => {
    ...
    <li className="roboto"> <NavLink to='/apartment' className={({ isActive }) => isActive ? ' text-[#23BE0A] border border-[#23BE0A]' : ''} > About </NavLink> </li>
    ...
    return (
        <div className="navbar bg-base-100 ">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl roboto">MiaSumon</a>
            </div>
